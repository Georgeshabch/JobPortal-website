...
function JobCard({ job, onClick, onToggleSave, saved , hideApply , onApply }) {
  ...
  return (
    <div 
    onClick={onClick}
    className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl hover:shadow-gray-200 transition-all duration-300 group relative cursor-pointer overflow-hidden">
        <div className="flex items-start justify-between mb-4">
            <div className="flex items-start gap-4">
                {job?.company?.companyLogo ? (
                    ...
                    <div className="h-14 w-14 bg-gray-50 border-2 border-gray-200 rounded-2xl flex items-center justify-center">
        ...
        <div className="mb-5">
            <div className="flex items-center gap-2 text-xs">
                <span className="flex items-center gap-2.5 bg-gray-100 text-gray-700 px-3 py-1 rounded-full font-medium">
