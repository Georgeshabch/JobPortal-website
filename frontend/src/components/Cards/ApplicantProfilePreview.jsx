...
function ApplicantProfilePreview({
  ...
  // Safe fallback to prevent null errors
          ...
          <div className="text-center mb-6">
            {applicant?.avatar ? (
              <img
                ...
                className="h-22 w-22 rounded-full object-cover mx-auto"
              />
            ) : (
              <div className="h-22 w-22 rounded-full bg-blue-100 flex items-center justify-center mx-auto">
            ...
            <div className="bg-gray-100 rounded-lg p-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <StatusBage status={currentStatus} />
                </div>
                <div className="flex justify-between">
