  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        {/* Header with glassmorphisn effect */}
        <div className="mb-8 backdrop-blur-sm bg-white border border-white/20 shadow-xl rounded-2xl px-6 pt-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="group flex items-center space-x-2 px-6 py-3 text-xs md:text-sm text-gray-600 hover:text-white hover:bg-white bg-white/50 hover:bg-gradient-to-r 
            hover:from-blue-500 hover:to-blue-600 border border-gray-200 hover:border-transparent rounded-xl transition-all duration-300
          ...
          <div>
            ...
            {/* Content section */}
            <div className="px-8 pb-8 space-x-8">
              {/* Salary section */}
              ...
              <div className="space-y-4  mt-6">
                ...
                {/* Requirements */}
                <div className="space-y-4  mt-6">
                  <h3 className="text-2xl mt-2 font-bold text-gray-900 flex items-center space-x-3">
