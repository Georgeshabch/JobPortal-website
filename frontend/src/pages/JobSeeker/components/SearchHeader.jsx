...
function SearchHeader({ filters , handleFilterChange }) {
  return (
      ...
      <div className="flex flex-col gap-4 lg:gap-6">
        <div className="text-center lg:text-left">
          ...
          <p className="text-gray-600 text-sm lg:text-base">
            Discover opportunities that match your objectives and skills.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
          ...
          <button className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 lg:px-10 py-3 lg:py-2.5 rounded-xl lg:rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-200 text-base font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
            Search Jobs
            </button>
        </div>
      </div>
