      ...
      <div className="min-h-screen py-8 px-4 mt-16 lg:mt-20">
        ...
        {jobDetails && (
          <div className="bg-white p-6 rounded-lg max-w-7xl mx-auto">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  {jobDetails?.applicationStatus ? (
                    <StatusBage status={jobDetails.applicationStatus} />
                  ) : (
                    <button
                      onClick={applyForJob}
                      className="bg-gradient-to-r from-blue-50 to-blue-50 text-blue-700 hover:text-white px-6 py-2.5 rounded-xl hover:from-blue-500 hover:to-blue-600 transition-all duration-200 font-semibold transform hover:-translate-y-0.5"
                    >
                      Apply Now
                    </button>
                  )}
            ...
            {/* Content sections */}
            <div className="px-0 py-8 space-y-8">
              {/* Salary section */}
              ...
              <div className="space-x-4">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-100 mt-4 rounded-xl p-6">
              ...
              <div className="space-x-4">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 mt-4 rounded-xl p-6">
                  <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
