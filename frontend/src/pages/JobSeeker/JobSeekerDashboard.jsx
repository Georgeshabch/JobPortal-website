  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="min-h-screen mt-16">
        ...
        <div className="flex gap-6 lg:gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 lg:pb-20">
          {/* Desktop Sidebar Filters */}
          <div className="hidden lg:block w-80 flex-shrink-0">
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 p-6 sticky top-20">
              <h3 className="font-bold text-gray-900 text-xl mb-6">Filters Jobs</h3>
              <FilterContent 
              toggleSection={toggleSection}
              clearAllFilters={clearAllFilters}
              expandedSections={expandedSections}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6 lg:mb-8 gap-4">
              ...
              <div className="flex items-center justify-between lg:justify-end gap-4">
                ...
                className="lg:hidden flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-gray-200 font-medium text-gray-700 hover:bg-gray-50 transition-colors shadow-sm">
            ...
            {jobs.length === 0 ? (
              <div className="text-center py-16 lg:py-20 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/20">
                ...
                <p className="text-gray-600 mb-6">
                  Try adjusting your filters or search criteria to find more job
                </p>
                <button
                onClick={clearAllFilters}
                className="bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-700 shadow-lg transition-colors">
                  Clear All Filters
                </button>
              </div>
            ) : (
