...
function SignUp() {
  ...
  return (
    ...
    <div className="min-h-screen mt-5 mb-5 flex items-center justify-center bg-gray-50 px-4">
      <motion.div
      ...
      >
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 text-sm">
            Join thousands of professionals on JobPortal. Let's get started!
          </p>
        </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mt-1">JGP , PNG up to 5MB</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="text-xs text-gray-700">Hiring talent</div>
              </button>
            </div>
