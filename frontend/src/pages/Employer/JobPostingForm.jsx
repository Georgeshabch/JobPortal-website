    ...
    const fetchJobDetails = async () => {
      if (jobId) {
        try {
          ...
          if (error.response) {
            console.error("API Error:" , error.message.data.message);
          }
        }
      }
    };
          ...
          <div className="bg-white shadow-xl rounded-2xl p-6">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="group flex items-center space-x-2 px-6 py-3 text-sm font-medium text-gray-600 hover:text-white bg-white/50 hover:bg-gradient-to-r 
                hover:from-blue-500 hover:to-blue-600 border border-gray-200 hover:border-transparent rounded-xl transition-all duration-300 shadow-lg shadow-gray-100
            ...
            <div className="space-y-6">
              ...
              <TextareaField
                ...
                helperText="Include key responsibilities, day-to-day tasks, and what makes this role excitiing"
                required
              />
