...
// @desc Get logged-in user's applicationa
...
// @desc Get Application b ID (Jobseeker or Employer)
...
exports.updateStatus = async (req, res) => {
    try {
        ...
        if (!app || app.job.company.toString() !== req.user._id.toString()) {
            return res.status(403).json({ message: 'Not authorized to update this applications' });
        }
