...
exports.getJobs = async (req, res) => {
    ...
    try {
        ...
        if (userId) {
            ...
            savedJobIds = saveJobs.map((s) => String(s.job));
...
exports.getJobsEmployer = async (req, res) => {
    try {
        ...
        const jobs = await Job.find({ company: userId })
            ...
            .lean(); // .leam() makes jobs plain JS objects so we can add new fields

        // Count applicantions for each job
...
exports.getJobById = async (req, res) => {
    try {
        ...
        if (userId) {
            ...
            if (application) {
                applicantionStatus = application.status;
            }
        }
